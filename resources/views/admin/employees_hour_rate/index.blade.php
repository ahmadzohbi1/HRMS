                        ...
                        <thead>
                            ...
                            @foreach ($hour_data as $data)
                                ...
                                <tr class="odd">
                                    ...
                                    <td>{{$data->currency}}</td>
                                    <td>
                                        <a href="{{ route('hour_rate.edit', $data->id) }}" class="btn btn-warning btn-md">Edit
                                            Hour Rate</a>
                                        <form action="{{ route('hour_rate.destroy', $data->id) }}" method="POST"
                                            style="display:inline;"
                                            onsubmit="return confirm('Are you sure you want to delete this hour rate?');">
                                            @csrf
                                            @method('DELETE')
