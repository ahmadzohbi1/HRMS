            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('shifts.store') }}">
                        ...
                        <div id="department_field" class="form-group mb-3" style="display:none;">
                        ...
                        <div id="employee_field" class="form-group mb-3" style="display:none;">
...
@section('script')
    ...
    <script>
        ...
        document.getElementById('shift_type').addEventListener('change', function () {
            ...
            console.log("Shift Type Selected:", shiftType); // Debugging statement
