...
@section('title')
    @lang('translation.edit_resource', ['resource' => __('attributes.email')])
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate
                          action="{{ route('templates.email.update', $email->id)}}"
                          method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="title" name="title"
                                               value="{{ old('title', $email->title) }}" required>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="type" name="type"
                                               value="{{ old('type', $email->type) }}" readonly required>
                                        <div class="valid-feedback">
                                            @lang('validation.good')
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="body" id="body" class="form-control" rows="10"
                                                  required>{{ old('body', $email->body) }}</textarea>
                                        <div class="invalid-feedback">
